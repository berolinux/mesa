...
/* tick189 / pass27: G0–G4 symmetry inherits pass26 impl wire */
#define NV_PASS27_G0_G4_SYMMETRY_AUDIT       1
#define NV_PASS27_G0_G4_HOST_SEMA_IS_PASS21  1
#define NV_PASS27_G1_CE_PASS26               1
#define NV_PASS27_G2_COMPUTE_PASS26          1
#define NV_PASS27_G3_3D_PASS26_BARRIER       1
#define NV_PASS27_G4_VIDEO_PASS26_PASS27     1
#define NV_PASS27_G0_G4_SYMMETRY_TICK189     1

/** tick189: pass27 host sema tail — alias pass26/25/21. */
static inline int
nv_push_g0_g4_host_sema_tail_pass27(struct nv_push *p,
                                    bool pre_wfi_on_cur_subch,
                                    uint64_t host_sema_gpu,
                                    uint32_t host_sema_payload,
                                    enum nv_host_sema_mode host_sema_mode)
{
   return nv_push_g0_g4_host_sema_tail_pass26(p, pre_wfi_on_cur_subch,
                                              host_sema_gpu, host_sema_payload,
                                              host_sema_mode);
}

/** tick189: pass27 G0–G4 symmetry coherent with pass26 wire + pass27 policy. */
static inline bool
nv_pass27_g0_g4_symmetry_ok(void)
{
   return NV_PASS27_G0_G4_SYMMETRY_AUDIT != 0 &&
          NV_PASS27_G0_G4_HOST_SEMA_IS_PASS21 != 0 &&
          NV_PASS27_G0_G4_SYMMETRY_TICK189 != 0 &&
          nv_pass26_g0_g4_symmetry_ok() &&
          NV_PASS27_G1_CE_PASS26 != 0 &&
          NV_PASS27_G2_COMPUTE_PASS26 != 0 &&
          NV_PASS27_G3_3D_PASS26_BARRIER != 0 &&
          NV_PASS27_G4_VIDEO_PASS26_PASS27 != 0;
}

/* tick191 / pass28: G0–G4 symmetry inherits pass27 impl wire */
#define NV_PASS28_G0_G4_SYMMETRY_AUDIT       1
#define NV_PASS28_G0_G4_HOST_SEMA_IS_PASS21  1
#define NV_PASS28_G1_CE_PASS27               1
#define NV_PASS28_G2_COMPUTE_PASS27          1
#define NV_PASS28_G3_3D_PASS27_BARRIER       1
#define NV_PASS28_G4_VIDEO_PASS27_PASS28     1
#define NV_PASS28_G0_G4_SYMMETRY_TICK191     1

/** tick191: pass28 host sema tail — alias pass27/26/25/21. */
static inline int
nv_push_g0_g4_host_sema_tail_pass28(struct nv_push *p,
                                    bool pre_wfi_on_cur_subch,
                                    uint64_t host_sema_gpu,
                                    uint32_t host_sema_payload,
                                    enum nv_host_sema_mode host_sema_mode)
{
   return nv_push_g0_g4_host_sema_tail_pass27(p, pre_wfi_on_cur_subch,
                                              host_sema_gpu, host_sema_payload,
                                              host_sema_mode);
}

/** tick191: pass28 G0–G4 symmetry coherent with pass27 wire + pass28 policy. */
static inline bool
nv_pass28_g0_g4_symmetry_ok(void)
{
   return NV_PASS28_G0_G4_SYMMETRY_AUDIT != 0 &&
          NV_PASS28_G0_G4_HOST_SEMA_IS_PASS21 != 0 &&
          NV_PASS28_G0_G4_SYMMETRY_TICK191 != 0 &&
          nv_pass27_g0_g4_symmetry_ok() &&
          NV_PASS28_G1_CE_PASS27 != 0 &&
          NV_PASS28_G2_COMPUTE_PASS27 != 0 &&
          NV_PASS28_G3_3D_PASS27_BARRIER != 0 &&
          NV_PASS28_G4_VIDEO_PASS27_PASS28 != 0;
}

/* tick193 / pass29: G0–G4 symmetry inherits pass28 impl wire */
#define NV_PASS29_G0_G4_SYMMETRY_AUDIT       1
#define NV_PASS29_G0_G4_HOST_SEMA_IS_PASS21  1
#define NV_PASS29_G1_CE_PASS28               1
#define NV_PASS29_G2_COMPUTE_PASS28          1
#define NV_PASS29_G3_3D_PASS28_BARRIER       1
#define NV_PASS29_G4_VIDEO_PASS28_PASS29     1
#define NV_PASS29_G0_G4_SYMMETRY_TICK193     1

/** tick193: pass29 host sema tail — alias pass28/27/26/25/21. */
static inline int
nv_push_g0_g4_host_sema_tail_pass29(struct nv_push *p,
                                    bool pre_wfi_on_cur_subch,
                                    uint64_t host_sema_gpu,
                                    uint32_t host_sema_payload,
                                    enum nv_host_sema_mode host_sema_mode)
{
   return nv_push_g0_g4_host_sema_tail_pass28(p, pre_wfi_on_cur_subch,
                                              host_sema_gpu, host_sema_payload,
                                              host_sema_mode);
}

/** tick193: pass29 G0–G4 symmetry coherent with pass28 wire + pass29 policy. */
static inline bool
nv_pass29_g0_g4_symmetry_ok(void)
{
   return NV_PASS29_G0_G4_SYMMETRY_AUDIT != 0 &&
          NV_PASS29_G0_G4_HOST_SEMA_IS_PASS21 != 0 &&
          NV_PASS29_G0_G4_SYMMETRY_TICK193 != 0 &&
          nv_pass28_g0_g4_symmetry_ok() &&
          NV_PASS29_G1_CE_PASS28 != 0 &&
          NV_PASS29_G2_COMPUTE_PASS28 != 0 &&
          NV_PASS29_G3_3D_PASS28_BARRIER != 0 &&
          NV_PASS29_G4_VIDEO_PASS28_PASS29 != 0;
}

/* tick195 / pass30: G0–G4 symmetry inherits pass29 impl wire */
#define NV_PASS30_G0_G4_SYMMETRY_AUDIT       1
#define NV_PASS30_G0_G4_HOST_SEMA_IS_PASS21  1
#define NV_PASS30_G1_CE_PASS29               1
#define NV_PASS30_G2_COMPUTE_PASS29          1
#define NV_PASS30_G3_3D_PASS29_BARRIER       1
#define NV_PASS30_G4_VIDEO_PASS29_PASS30     1
#define NV_PASS30_G0_G4_SYMMETRY_TICK195     1

/** tick195: pass30 host sema tail — alias pass29/28/27/26/21. */
static inline int
nv_push_g0_g4_host_sema_tail_pass30(struct nv_push *p,
                                    bool pre_wfi_on_cur_subch,
                                    uint64_t host_sema_gpu,
                                    uint32_t host_sema_payload,
                                    enum nv_host_sema_mode host_sema_mode)
{
   return nv_push_g0_g4_host_sema_tail_pass29(p, pre_wfi_on_cur_subch,
                                              host_sema_gpu, host_sema_payload,
                                              host_sema_mode);
}

/** tick195: pass30 G0–G4 symmetry coherent with pass29 wire + pass30 policy. */
static inline bool
nv_pass30_g0_g4_symmetry_ok(void)
{
   return NV_PASS30_G0_G4_SYMMETRY_AUDIT != 0 &&
          NV_PASS30_G0_G4_HOST_SEMA_IS_PASS21 != 0 &&
          NV_PASS30_G0_G4_SYMMETRY_TICK195 != 0 &&
          nv_pass29_g0_g4_symmetry_ok() &&
          NV_PASS30_G1_CE_PASS29 != 0 &&
          NV_PASS30_G2_COMPUTE_PASS29 != 0 &&
          NV_PASS30_G3_3D_PASS29_BARRIER != 0 &&
          NV_PASS30_G4_VIDEO_PASS29_PASS30 != 0;
}

/* tick197 / pass31: G0–G4 symmetry inherits pass30 impl wire */
#define NV_PASS31_G0_G4_SYMMETRY_AUDIT       1
#define NV_PASS31_G0_G4_HOST_SEMA_IS_PASS21  1
#define NV_PASS31_G1_CE_PASS30               1
#define NV_PASS31_G2_COMPUTE_PASS30          1
#define NV_PASS31_G3_3D_PASS30_BARRIER       1
#define NV_PASS31_G4_VIDEO_PASS30_PASS31     1
#define NV_PASS31_G0_G4_SYMMETRY_TICK197     1

/** tick197: pass31 host sema tail — alias pass30/29/28/27/26/21. */
static inline int
nv_push_g0_g4_host_sema_tail_pass31(struct nv_push *p,
                                    bool pre_wfi_on_cur_subch,
                                    uint64_t host_sema_gpu,
                                    uint32_t host_sema_payload,
                                    enum nv_host_sema_mode host_sema_mode)
{
   return nv_push_g0_g4_host_sema_tail_pass30(p, pre_wfi_on_cur_subch,
                                              host_sema_gpu, host_sema_payload,
                                              host_sema_mode);
}

/** tick197: pass31 G0–G4 symmetry coherent with pass30 wire + pass31 policy. */
static inline bool
nv_pass31_g0_g4_symmetry_ok(void)
{
   return NV_PASS31_G0_G4_SYMMETRY_AUDIT != 0 &&
          NV_PASS31_G0_G4_HOST_SEMA_IS_PASS21 != 0 &&
          NV_PASS31_G0_G4_SYMMETRY_TICK197 != 0 &&
          nv_pass30_g0_g4_symmetry_ok() &&
          NV_PASS31_G1_CE_PASS30 != 0 &&
          NV_PASS31_G2_COMPUTE_PASS30 != 0 &&
          NV_PASS31_G3_3D_PASS30_BARRIER != 0 &&
          NV_PASS31_G4_VIDEO_PASS30_PASS31 != 0;
}
