...
/**
 * tick190 / pass27: G1 CE copy + pass27 host sema.
 */
static inline int
nv_g1_emit_copy_then_host_sema_pass27(struct nv_push *p, uint32_t class_copy,
                                      uint64_t src_gpu_addr,
                                      uint64_t dst_gpu_addr,
                                      uint32_t size_bytes,
                                      bool pipelined,
...
/**
 * tick192 / pass28: G1 CE copy + pass28 host sema.
 */
static inline int
nv_g1_emit_copy_then_host_sema_pass28(struct nv_push *p, uint32_t class_copy,
                                      uint64_t src_gpu_addr,
                                      uint64_t dst_gpu_addr,
                                      uint32_t size_bytes,
                                      bool pipelined,
...
/**
 * tick194 / pass29: G1 CE copy + pass29 host sema.
 */
static inline int
nv_g1_emit_copy_then_host_sema_pass29(struct nv_push *p, uint32_t class_copy,
                                      uint64_t src_gpu_addr,
                                      uint64_t dst_gpu_addr,
                                      uint32_t size_bytes,
                                      bool pipelined,
...
/**
 * tick196 / pass30: G1 CE copy + pass30 host sema.
 */
static inline int
nv_g1_emit_copy_then_host_sema_pass30(struct nv_push *p, uint32_t class_copy,
                                      uint64_t src_gpu_addr,
                                      uint64_t dst_gpu_addr,
                                      uint32_t size_bytes,
                                      bool pipelined,
