...
#define NV_PASS25_IMPL_G4_CHANNEL_TICK184        1

/* tick184 / pass26 scaffold — inherits pass25 impl wire; RE TBD */
#define NV_PASS26_RE_SCAFFOLD                    1
#define NV_PASS26_RE_INHERITS_PASS25             1
#define NV_PASS26_RE_EXPLICIT_EMIT_POLICY        NV_PASS25_RE_EXPLICIT_EMIT_POLICY
...
/* tick190: pass27 G1/G3/G4 bringup helpers wired */
#define NV_PASS27_IMPL_G1_G3_G4_TICK190          1
#define NV_PASS27_IMPL_G1_CHANNEL_TICK190        1
#define NV_PASS27_IMPL_G3_CHANNEL_TICK190        1
#define NV_PASS27_IMPL_G4_CHANNEL_TICK190        1
/* tick191: pass27 implementation audit (RE full disasm still pending) */
#define NV_PASS27_IMPL_AUDIT_TICK191             1
#define NV_PASS27_IMPL_SCAFFOLD_TICK188          1
#define NV_PASS27_IMPL_G0_G4_SYMMETRY_TICK189    1
#define NV_PASS27_IMPL_G2_CHANNEL_TICK189        1
#define NV_PASS27_IMPL_WIRE_COMPLETE             1
#define NV_PASS27_RE_TRACE_SCAFFOLD_TICK191      1

/* tick191 / pass28 scaffold — inherits pass27 impl wire; RE TBD */
#define NV_PASS28_RE_SCAFFOLD                    1
#define NV_PASS28_RE_INHERITS_PASS27             1
#define NV_PASS28_RE_EXPLICIT_EMIT_POLICY        NV_PASS27_RE_EXPLICIT_EMIT_POLICY
...
/* tick194: pass29 G1/G3/G4 bringup helpers wired */
#define NV_PASS29_IMPL_G1_G3_G4_TICK194          1
#define NV_PASS29_IMPL_G1_CHANNEL_TICK194        1
#define NV_PASS29_IMPL_G3_CHANNEL_TICK194        1
#define NV_PASS29_IMPL_G4_CHANNEL_TICK194        1
/* tick195: pass29 implementation audit — wire complete */
#define NV_PASS29_IMPL_AUDIT_TICK195             1
#define NV_PASS29_IMPL_SCAFFOLD_TICK193          1
#define NV_PASS29_IMPL_G0_G4_SYMMETRY_TICK193    1
#define NV_PASS29_IMPL_G2_CHANNEL_TICK193        1
#define NV_PASS29_IMPL_WIRE_COMPLETE             1
#define NV_PASS29_RE_TRACE_SCAFFOLD_TICK195      1

/* tick195 / pass30 scaffold — inherits pass29 impl wire; RE TBD */
#define NV_PASS30_RE_SCAFFOLD                    1
#define NV_PASS30_RE_INHERITS_PASS29             1
#define NV_PASS30_RE_EXPLICIT_EMIT_POLICY        NV_PASS29_RE_EXPLICIT_EMIT_POLICY
#define NV_PASS30_RE_PATH_C_STILL_GATED          NV_PASS29_RE_PATH_C_STILL_GATED
#define NV_PASS30_RE_FULL_DISASM_PENDING         1
#define NV_PASS30_IMPL_INHERITS_PASS29_WIRE      NV_PASS29_IMPL_WIRE_COMPLETE
/* tick196: pass30 G1/G3/G4 bringup helpers wired */
#define NV_PASS30_IMPL_G1_G3_G4_TICK196          1
#define NV_PASS30_IMPL_G1_CHANNEL_TICK196        1
#define NV_PASS30_IMPL_G3_CHANNEL_TICK196        1
#define NV_PASS30_IMPL_G4_CHANNEL_TICK196        1
/* tick197: pass30 implementation audit — wire complete */
#define NV_PASS30_IMPL_AUDIT_TICK197             1
#define NV_PASS30_IMPL_SCAFFOLD_TICK195          1
#define NV_PASS30_IMPL_G0_G4_SYMMETRY_TICK195    1
#define NV_PASS30_IMPL_G2_CHANNEL_TICK195        1
#define NV_PASS30_IMPL_WIRE_COMPLETE             1
#define NV_PASS30_RE_TRACE_SCAFFOLD_TICK197      1

/* tick197 / pass31 scaffold — inherits pass30 impl wire; RE TBD */
#define NV_PASS31_RE_SCAFFOLD                    1
#define NV_PASS31_RE_INHERITS_PASS30             1
#define NV_PASS31_RE_EXPLICIT_EMIT_POLICY        NV_PASS30_RE_EXPLICIT_EMIT_POLICY
...
/** tick183: pass25 mesa G0–G4 wire complete; pass25 RE still pending. */
static inline bool
nv_pass25_implementation_audit_ok(void)
{
   return NV_PASS25_IMPL_AUDIT_TICK183 != 0 &&
          NV_PASS25_IMPL_SCAFFOLD_TICK180 != 0 &&
...
/** tick191: pass27 mesa G0–G4 wire complete; pass27 RE still pending. */
static inline bool
nv_pass27_implementation_audit_ok(void)
{
   return NV_PASS27_IMPL_AUDIT_TICK191 != 0 &&
          NV_PASS27_IMPL_SCAFFOLD_TICK188 != 0 &&
          NV_PASS27_IMPL_G0_G4_SYMMETRY_TICK189 != 0 &&
          NV_PASS27_IMPL_G1_G3_G4_TICK190 != 0 &&
          NV_PASS27_IMPL_G2_CHANNEL_TICK189 != 0 &&
          NV_PASS27_IMPL_G1_CHANNEL_TICK190 != 0 &&
          NV_PASS27_IMPL_G3_CHANNEL_TICK190 != 0 &&
          NV_PASS27_IMPL_G4_CHANNEL_TICK190 != 0 &&
          NV_PASS27_IMPL_WIRE_COMPLETE != 0 &&
          nv_pass27_policy_ok() &&
          NV_PASS27_RE_FULL_DISASM_PENDING != 0;
}

static inline bool
nv_pass28_policy_ok(void)
{
   return NV_PASS28_RE_SCAFFOLD != 0 &&
...
/** tick195: pass29 mesa G0–G4 wire complete; pass29 RE still pending. */
static inline bool
nv_pass29_implementation_audit_ok(void)
{
   return NV_PASS29_IMPL_AUDIT_TICK195 != 0 &&
          NV_PASS29_IMPL_SCAFFOLD_TICK193 != 0 &&
          NV_PASS29_IMPL_G0_G4_SYMMETRY_TICK193 != 0 &&
          NV_PASS29_IMPL_G1_G3_G4_TICK194 != 0 &&
          NV_PASS29_IMPL_G2_CHANNEL_TICK193 != 0 &&
          NV_PASS29_IMPL_G1_CHANNEL_TICK194 != 0 &&
          NV_PASS29_IMPL_G3_CHANNEL_TICK194 != 0 &&
          NV_PASS29_IMPL_G4_CHANNEL_TICK194 != 0 &&
          NV_PASS29_IMPL_WIRE_COMPLETE != 0 &&
          nv_pass29_policy_ok() &&
          NV_PASS29_RE_FULL_DISASM_PENDING != 0;
}

static inline bool
nv_pass30_policy_ok(void)
{
   return NV_PASS30_RE_SCAFFOLD != 0 &&
          NV_PASS30_RE_INHERITS_PASS29 != 0 &&
          nv_pass29_implementation_audit_ok() &&
          NV_PASS30_RE_PATH_C_STILL_GATED != 0;
}

/** tick197: pass30 mesa G0–G4 wire complete; pass30 RE still pending. */
static inline bool
nv_pass30_implementation_audit_ok(void)
{
   return NV_PASS30_IMPL_AUDIT_TICK197 != 0 &&
          NV_PASS30_IMPL_SCAFFOLD_TICK195 != 0 &&
          NV_PASS30_IMPL_G0_G4_SYMMETRY_TICK195 != 0 &&
          NV_PASS30_IMPL_G1_G3_G4_TICK196 != 0 &&
          NV_PASS30_IMPL_G2_CHANNEL_TICK195 != 0 &&
          NV_PASS30_IMPL_G1_CHANNEL_TICK196 != 0 &&
          NV_PASS30_IMPL_G3_CHANNEL_TICK196 != 0 &&
          NV_PASS30_IMPL_G4_CHANNEL_TICK196 != 0 &&
          NV_PASS30_IMPL_WIRE_COMPLETE != 0 &&
          nv_pass30_policy_ok() &&
          NV_PASS30_RE_FULL_DISASM_PENDING != 0;
}

static inline bool
nv_pass31_policy_ok(void)
{
   return NV_PASS31_RE_SCAFFOLD != 0 &&
          NV_PASS31_RE_INHERITS_PASS30 != 0 &&
          nv_pass30_implementation_audit_ok() &&
          NV_PASS31_RE_PATH_C_STILL_GATED != 0;
}
...
/**
 * tick154: G2 dispatch from pre-encoded QMD (nv_nir/nv_sph compile +
 * nv_qmd_build_pass17_qmd_sema_only).  Channel prep, pass20 launch (+WFI),
 * optional pass17 host sema tail.  Returns 0 on success, -1 on bad args.
 */
static inline int
nv_compute_emit_g2_qmd_launch_pass17(struct nv_push *p, uint32_t class_compute,
                                     const uint32_t qmd_dwords[NV_QMD_DWORDS],
                                     uint64_t qmd_gpu_addr,
                                     uint64_t lmem_gpu_addr,
                                     uint8_t spa_version,
                                     bool post_wfi,
