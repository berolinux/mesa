                                  ...
                                  uint32_t *push_dwords_out)
{
   ...
   /* tick168: pass23 RE scaffold inherits pass22 policy */
   {
      ...
      /* tick179: pass24 implementation audit (RE full disasm still pending) */
      if (!NV_PASS24_IMPL_AUDIT_TICK179 || !NV_PASS24_RE_TRACE_SCAFFOLD_TICK179)
         return -867;
      if (!nv_pass24_implementation_audit_ok())
         return -868;
      if (!NV_PASS24_IMPL_WIRE_COMPLETE || !NV_PASS24_IMPL_G0_G4_SYMMETRY_TICK178)
         return -869;
      if (!NV_PASS24_IMPL_G2_CHANNEL_TICK177 ||
          !NV_PASS24_IMPL_GALLIUM_VK_TAIL_TICK177)
         return -870;
      if (NV_PASS24_RE_FULL_DISASM_PENDING == 0)
      ...
      /* tick182: pass25 G1/G3/G4 helpers */
      {
         struct nv_push p182;
         uint32_t b182[128];
         memset(b182, 0, sizeof(b182));
         nv_push_init(&p182, b182, (uint32_t)(sizeof(b182) / 4));
         if (nv_g1_emit_copy_then_host_sema_pass25(
                &p182, 0xc5b5u, 0x1000ull, 0x2000ull, 64u, false, true,
                0x5f0000ull, 1u, NV_PASS21_HOST_SEMA_DEFAULT_MODE) != 0)
            return -886;
         if (nv_push_dw_count(&p182) < 8u)
            return -887;
      }
      {
         struct nv_push p182g3;
         uint32_t b182g3[128];
         memset(b182g3, 0, sizeof(b182g3));
         nv_push_init(&p182g3, b182g3, (uint32_t)(sizeof(b182g3) / 4));
         if (nv_3d_emit_g3_barrier_all_pass25(
                &p182g3, 0x600000ull, 1u, NV_PASS21_HOST_SEMA_DEFAULT_MODE) != 0)
            return -888;
         if (nv_3d_emit_g3_inv_wfi_host_sema_pass25(
                &p182g3, 0x600000ull, 1u, NV_PASS21_HOST_SEMA_DEFAULT_MODE,
                true) != 0)
            return -889;
      }
      ...
      if (!nv_pass25_g0_g4_symmetry_ok() || !nv_pass25_policy_ok())
         return -895;
      /* tick184: pass25 G4 channel wire + pass26 scaffold */
      if (!NV_PASS25_IMPL_G4_CHANNEL_TICK184)
         return -896;
      if (!NV_PASS26_RE_SCAFFOLD || !NV_PASS26_RE_INHERITS_PASS25)
         return -897;
      if (!nv_pass26_policy_ok() || NV_PASS26_RE_FULL_DISASM_PENDING == 0)
         return -898;
      if (NV_PASS26_IMPL_INHERITS_PASS25_WIRE != NV_PASS25_IMPL_WIRE_COMPLETE)
         return -899;
      /* tick185: pass26 G0–G4 symmetry + G2 launch ladder */
      if (!NV_PASS26_G0_G4_SYMMETRY_TICK185 || !nv_pass26_g0_g4_symmetry_ok())
         return -900;
      if (!NV_PASS26_G1_CE_PASS25 || !NV_PASS26_G2_COMPUTE_PASS25 ||
          !NV_PASS26_G3_3D_PASS25_BARRIER || !NV_PASS26_G4_VIDEO_PASS25_PASS26)
         return -901;
      if (!NV_PASS26_CHANNEL_G2_LAUNCH_LADDER ||
          !NV_PASS26_GALLIUM_VULKAN_DISPATCH_TAIL)
         return -902;
      {
         struct nv_push p185;
         uint32_t b185[32];
         memset(b185, 0, sizeof(b185));
         nv_push_init(&p185, b185, (uint32_t)(sizeof(b185) / 4));
         if (nv_push_g0_g4_host_sema_tail_pass26(
                &p185, false, 0x610000ull, 1u,
                NV_PASS21_HOST_SEMA_DEFAULT_MODE) != 0)
            return -903;
         if (nv_pass26_emit_compute_dispatch_host_sema_tail(
                &p185, 0x610000ull, 1u, NV_PASS21_HOST_SEMA_DEFAULT_MODE,
                false) != 0)
            return -904;
      }
      {
         struct nv_push p185b;
         uint32_t b185b[256];
         struct nv_pass21_compute_object o185;
         memset(b185b, 0, sizeof(b185b));
         memset(&o185, 0, sizeof(o185));
         nv_push_init(&p185b, b185b, (uint32_t)(sizeof(b185b) / 4));
         o185.shader_kind = NV_PASS24_NIR_DEFAULT_KIND;
         o185.program_gpu_addr = 0x100000ull;
         o185.qmd_gpu_addr = 0x200000ull;
         o185.qmd_sema_gpu = 0x210000ull;
         o185.qmd_sema_payload = 1u;
         o185.register_count = 8u;
         o185.spa_version = 0x0700u;
         o185.grid_x = 1u;
         o185.cta_x = 32u;
         if (nv_pass22_compute_object_build(&o185) != 0)
            return -905;
         if (nv_pass26_compute_object_emit_launch(
                &p185b, 0xc5c0u, &o185, 0x400000ull, true, 0x210000ull, 1u,
                NV_PASS21_HOST_SEMA_DEFAULT_MODE) != 0)
            return -906;
      }
      ...
      /* tick187: pass26 implementation audit */
      if (!NV_PASS26_IMPL_AUDIT_TICK187 || !NV_PASS26_RE_TRACE_SCAFFOLD_TICK187)
         return -911;
      if (!nv_pass26_implementation_audit_ok())
         return -912;
      if (!NV_PASS26_IMPL_WIRE_COMPLETE || !NV_PASS26_IMPL_G1_G3_G4_TICK186)
         return -913;
      if (!NV_PASS26_IMPL_G0_G4_SYMMETRY_TICK185 ||
          !NV_PASS26_IMPL_G2_CHANNEL_TICK185)
         return -914;
      if (NV_PASS26_RE_FULL_DISASM_PENDING == 0)
         return -915;
      ...
      if (NV_PASS27_IMPL_INHERITS_PASS26_WIRE != NV_PASS26_IMPL_WIRE_COMPLETE)
         return -920;
      /* tick189: pass27 G0–G4 symmetry + G2 launch ladder */
      if (!NV_PASS27_G0_G4_SYMMETRY_TICK189 || !nv_pass27_g0_g4_symmetry_ok())
         return -921;
      if (!NV_PASS27_G1_CE_PASS26 || !NV_PASS27_G2_COMPUTE_PASS26 ||
          !NV_PASS27_G3_3D_PASS26_BARRIER || !NV_PASS27_G4_VIDEO_PASS26_PASS27)
         return -922;
      if (!NV_PASS27_CHANNEL_G2_LAUNCH_LADDER ||
          !NV_PASS27_GALLIUM_VULKAN_DISPATCH_TAIL)
         return -923;
      {
         struct nv_push p189;
         uint32_t b189[32];
         memset(b189, 0, sizeof(b189));
         nv_push_init(&p189, b189, (uint32_t)(sizeof(b189) / 4));
         if (nv_push_g0_g4_host_sema_tail_pass27(
                &p189, false, 0x640000ull, 1u,
                NV_PASS21_HOST_SEMA_DEFAULT_MODE) != 0)
            return -924;
         if (nv_pass27_emit_compute_dispatch_host_sema_tail(
                &p189, 0x640000ull, 1u, NV_PASS21_HOST_SEMA_DEFAULT_MODE,
                false) != 0)
            return -925;
      }
      {
         struct nv_push p189b;
         uint32_t b189b[256];
         struct nv_pass21_compute_object o189;
         memset(b189b, 0, sizeof(b189b));
         memset(&o189, 0, sizeof(o189));
         nv_push_init(&p189b, b189b, (uint32_t)(sizeof(b189b) / 4));
         o189.shader_kind = NV_PASS24_NIR_DEFAULT_KIND;
         o189.program_gpu_addr = 0x100000ull;
         o189.qmd_gpu_addr = 0x200000ull;
         o189.qmd_sema_gpu = 0x210000ull;
         o189.qmd_sema_payload = 1u;
         o189.register_count = 8u;
         o189.spa_version = 0x0700u;
         o189.grid_x = 1u;
         o189.cta_x = 32u;
         if (nv_pass22_compute_object_build(&o189) != 0)
            return -926;
         if (nv_pass27_compute_object_emit_launch(
                &p189b, 0xc5c0u, &o189, 0x400000ull, true, 0x210000ull, 1u,
                NV_PASS21_HOST_SEMA_DEFAULT_MODE) != 0)
            return -927;
      }
      /* tick190: pass27 G1/G3/G4 helpers */
      {
         struct nv_push p190;
         uint32_t b190[128];
         memset(b190, 0, sizeof(b190));
         nv_push_init(&p190, b190, (uint32_t)(sizeof(b190) / 4));
         if (nv_g1_emit_copy_then_host_sema_pass27(
                &p190, 0xc5b5u, 0x1000ull, 0x2000ull, 64u, false, true,
                0x650000ull, 1u, NV_PASS21_HOST_SEMA_DEFAULT_MODE) != 0)
            return -928;
         if (nv_push_dw_count(&p190) < 8u)
            return -929;
      }
      {
         struct nv_push p190g3;
         uint32_t b190g3[128];
         memset(b190g3, 0, sizeof(b190g3));
         nv_push_init(&p190g3, b190g3, (uint32_t)(sizeof(b190g3) / 4));
         if (nv_3d_emit_g3_barrier_all_pass27(
                &p190g3, 0x660000ull, 1u, NV_PASS21_HOST_SEMA_DEFAULT_MODE) != 0)
            return -930;
         if (nv_3d_emit_g3_inv_wfi_host_sema_pass27(
                &p190g3, 0x660000ull, 1u, NV_PASS21_HOST_SEMA_DEFAULT_MODE,
                true) != 0)
            return -931;
      }
      if (!NV_PASS27_IMPL_G1_G3_G4_TICK190 ||
          !NV_PASS27_IMPL_G1_CHANNEL_TICK190 ||
          !NV_PASS27_IMPL_G3_CHANNEL_TICK190 ||
          !NV_PASS27_IMPL_G4_CHANNEL_TICK190)
         return -932;
      /* tick191: pass27 implementation audit */
      if (!NV_PASS27_IMPL_AUDIT_TICK191 || !NV_PASS27_RE_TRACE_SCAFFOLD_TICK191)
         return -933;
      if (!nv_pass27_implementation_audit_ok())
         return -934;
      if (!NV_PASS27_IMPL_WIRE_COMPLETE || !NV_PASS27_IMPL_G1_G3_G4_TICK190)
         return -935;
      if (!NV_PASS27_IMPL_G0_G4_SYMMETRY_TICK189 ||
          !NV_PASS27_IMPL_G2_CHANNEL_TICK189)
         return -936;
      if (NV_PASS27_RE_FULL_DISASM_PENDING == 0)
         return -937;
      if (!nv_pass27_g0_g4_symmetry_ok() || !nv_pass27_policy_ok())
         return -938;
      /* tick191: pass28 scaffold */
      if (!NV_PASS28_RE_SCAFFOLD || !NV_PASS28_RE_INHERITS_PASS27)
         return -939;
      if (!nv_pass28_policy_ok() || NV_PASS28_RE_FULL_DISASM_PENDING == 0)
         return -940;
      if (NV_PASS28_IMPL_INHERITS_PASS27_WIRE != NV_PASS27_IMPL_WIRE_COMPLETE)
         return -941;
      /* tick191: pass28 G0–G4 symmetry + G2 launch ladder */
      if (!NV_PASS28_G0_G4_SYMMETRY_TICK191 || !nv_pass28_g0_g4_symmetry_ok())
         return -942;
      if (!NV_PASS28_G1_CE_PASS27 || !NV_PASS28_G2_COMPUTE_PASS27 ||
          !NV_PASS28_G3_3D_PASS27_BARRIER || !NV_PASS28_G4_VIDEO_PASS27_PASS28)
         return -943;
      if (!NV_PASS28_CHANNEL_G2_LAUNCH_LADDER ||
          !NV_PASS28_GALLIUM_VULKAN_DISPATCH_TAIL)
         return -944;
      {
         struct nv_push p191;
         uint32_t b191[32];
         memset(b191, 0, sizeof(b191));
         nv_push_init(&p191, b191, (uint32_t)(sizeof(b191) / 4));
         if (nv_push_g0_g4_host_sema_tail_pass28(
                &p191, false, 0x670000ull, 1u,
                NV_PASS21_HOST_SEMA_DEFAULT_MODE) != 0)
            return -945;
         if (nv_pass28_emit_compute_dispatch_host_sema_tail(
                &p191, 0x670000ull, 1u, NV_PASS21_HOST_SEMA_DEFAULT_MODE,
                false) != 0)
            return -946;
      }
      {
         struct nv_push p191b;
         uint32_t b191b[256];
         struct nv_pass21_compute_object o191;
         memset(b191b, 0, sizeof(b191b));
         memset(&o191, 0, sizeof(o191));
         nv_push_init(&p191b, b191b, (uint32_t)(sizeof(b191b) / 4));
         o191.shader_kind = NV_PASS24_NIR_DEFAULT_KIND;
         o191.program_gpu_addr = 0x100000ull;
         o191.qmd_gpu_addr = 0x200000ull;
         o191.qmd_sema_gpu = 0x210000ull;
         o191.qmd_sema_payload = 1u;
         o191.register_count = 8u;
         o191.spa_version = 0x0700u;
         o191.grid_x = 1u;
         o191.cta_x = 32u;
         if (nv_pass22_compute_object_build(&o191) != 0)
            return -947;
         if (nv_pass28_compute_object_emit_launch(
                &p191b, 0xc5c0u, &o191, 0x400000ull, true, 0x210000ull, 1u,
                NV_PASS21_HOST_SEMA_DEFAULT_MODE) != 0)
            return -948;
      }
      /* tick192: pass28 G1/G3/G4 helpers */
      {
         struct nv_push p192;
         uint32_t b192[128];
         memset(b192, 0, sizeof(b192));
         nv_push_init(&p192, b192, (uint32_t)(sizeof(b192) / 4));
         if (nv_g1_emit_copy_then_host_sema_pass28(
                &p192, 0xc5b5u, 0x1000ull, 0x2000ull, 64u, false, true,
                0x680000ull, 1u, NV_PASS21_HOST_SEMA_DEFAULT_MODE) != 0)
            return -949;
         if (nv_push_dw_count(&p192) < 8u)
            return -950;
      }
      {
         struct nv_push p192g3;
         uint32_t b192g3[128];
         memset(b192g3, 0, sizeof(b192g3));
         nv_push_init(&p192g3, b192g3, (uint32_t)(sizeof(b192g3) / 4));
         if (nv_3d_emit_g3_barrier_all_pass28(
                &p192g3, 0x690000ull, 1u, NV_PASS21_HOST_SEMA_DEFAULT_MODE) != 0)
            return -951;
         if (nv_3d_emit_g3_inv_wfi_host_sema_pass28(
                &p192g3, 0x690000ull, 1u, NV_PASS21_HOST_SEMA_DEFAULT_MODE,
                true) != 0)
            return -952;
      }
      if (!NV_PASS28_IMPL_G1_G3_G4_TICK192 ||
          !NV_PASS28_IMPL_G1_CHANNEL_TICK192 ||
          !NV_PASS28_IMPL_G3_CHANNEL_TICK192 ||
          !NV_PASS28_IMPL_G4_CHANNEL_TICK192)
         return -953;
   }
   /* tick193: pass28 implementation audit */
   {
      if (!nv_pass28_implementation_audit_ok())
         return -954;
      if (!NV_PASS28_IMPL_AUDIT_TICK193)
         return -955;
      if (!NV_PASS28_IMPL_SCAFFOLD_TICK191)
         return -956;
      if (!NV_PASS28_IMPL_G0_G4_SYMMETRY_TICK191)
         return -957;
      if (!NV_PASS28_IMPL_G2_CHANNEL_TICK191)
         return -958;
      if (!NV_PASS28_IMPL_WIRE_COMPLETE)
         return -959;
      if (!NV_PASS28_RE_TRACE_SCAFFOLD_TICK193)
         return -960;
   }
   /* tick193: pass29 scaffold + G0-G4 symmetry + G2 launch */
   {
      if (!nv_pass29_policy_ok())
         return -961;
      if (!NV_PASS29_RE_SCAFFOLD)
         return -962;
      if (!NV_PASS29_RE_INHERITS_PASS28)
         return -963;
      if (!nv_pass29_g0_g4_symmetry_ok())
         return -964;
      if (!NV_PASS29_G0_G4_SYMMETRY_TICK193)
         return -965;
      if (!NV_PASS29_CHANNEL_G2_LAUNCH_LADDER)
         return -966;
      if (!NV_PASS29_GALLIUM_VULKAN_DISPATCH_TAIL)
         return -967;
      {
         struct nv_push p193;
         uint32_t b193[256];
         struct nv_pass21_compute_object o193;
         ...
         if (nv_pass22_compute_object_build(&o193) != 0)
            return -968;
         if (nv_pass29_compute_object_emit_launch(
                &p193, 0xc5c0u, &o193, 0x400000ull, true, 0x220000ull, 1u,
                NV_PASS21_HOST_SEMA_DEFAULT_MODE) != 0)
            return -969;
      }
   }
   /* tick194: pass29 G1/G3/G4 helpers */
   {
      struct nv_push p194;
      uint32_t b194[128];
      memset(b194, 0, sizeof(b194));
      nv_push_init(&p194, b194, (uint32_t)(sizeof(b194) / 4));
      if (nv_g1_emit_copy_then_host_sema_pass29(
             &p194, 0xc5b5u, 0x1000ull, 0x2000ull, 64u, false, true,
             0x6a0000ull, 1u, NV_PASS21_HOST_SEMA_DEFAULT_MODE) != 0)
         return -970;
      if (nv_push_dw_count(&p194) < 8u)
         return -971;
   }
   {
      struct nv_push p194g3;
      uint32_t b194g3[128];
      memset(b194g3, 0, sizeof(b194g3));
      nv_push_init(&p194g3, b194g3, (uint32_t)(sizeof(b194g3) / 4));
      if (nv_3d_emit_g3_barrier_all_pass29(
             &p194g3, 0x6b0000ull, 1u, NV_PASS21_HOST_SEMA_DEFAULT_MODE) != 0)
         return -972;
      if (nv_3d_emit_g3_inv_wfi_host_sema_pass29(
             &p194g3, 0x6b0000ull, 1u, NV_PASS21_HOST_SEMA_DEFAULT_MODE,
             true) != 0)
         return -973;
   }
   if (!NV_PASS29_IMPL_G1_G3_G4_TICK194 ||
       !NV_PASS29_IMPL_G1_CHANNEL_TICK194 ||
   ...
   if (!NV_PASS30_IMPL_G1_G3_G4_TICK196 ||
      ...
      return -995;
   /* tick197: pass30 implementation audit */
   {
      if (!nv_pass30_implementation_audit_ok())
         return -996;
      if (!NV_PASS30_IMPL_AUDIT_TICK197)
         return -997;
      if (!NV_PASS30_IMPL_SCAFFOLD_TICK195)
         return -998;
      if (!NV_PASS30_IMPL_G0_G4_SYMMETRY_TICK195)
         return -999;
      if (!NV_PASS30_IMPL_G2_CHANNEL_TICK195)
         return -1000;
      if (!NV_PASS30_IMPL_WIRE_COMPLETE)
         return -1001;
      if (!NV_PASS30_RE_TRACE_SCAFFOLD_TICK197)
         return -1002;
   }
   /* tick197: pass31 scaffold + G0-G4 symmetry + G2 launch */
   {
      if (!nv_pass31_policy_ok())
         return -1003;
      if (!NV_PASS31_RE_SCAFFOLD)
         return -1004;
      if (!NV_PASS31_RE_INHERITS_PASS30)
         return -1005;
      if (!nv_pass31_g0_g4_symmetry_ok())
         return -1006;
      if (!NV_PASS31_G0_G4_SYMMETRY_TICK197)
         return -1007;
      if (!NV_PASS31_CHANNEL_G2_LAUNCH_LADDER)
         return -1008;
      if (!NV_PASS31_GALLIUM_VULKAN_DISPATCH_TAIL)
         return -1009;
      {
         struct nv_push p197;
         uint32_t b197[256];
         struct nv_pass21_compute_object o197;
         ...
         if (nv_pass22_compute_object_build(&o197) != 0)
            return -1010;
         if (nv_pass31_compute_object_emit_launch(
